...
#define err(x,y) {printf y; printf("\n"); exit(x);}
#define warn(y) {printf y; printf("\n");}
...
void		set_cron_cwd (struct passwd *),
...
# endif /* DEBUGGING */
#else /*MAIN_PROGRAM*/
extern char HOME_DIR[MAX_FNAME];
extern char *CRONTAB_DIR;
extern char User[MAX_UNAME];
